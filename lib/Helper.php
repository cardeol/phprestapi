...
class Helper {
    ...
    public static function SendVerificationEmail($email, $hash) {
        ...
        $url = "https://makedeals.ie/verify/$email/$hash";

        if(ENVIRONMENT == "DEV") {
            $to = "cardeol@gmail.com";
            $url = "http://dev.makedeals.ie/app/verify/$email/$hash";
        };
        ...
        $headers = 'From: Makedeals.ie <noreply@makedeals.ie>' . "\r\n"; // Set from headers
    ...
    public static function SendResetPassword($email, $hash) {
        ...
        $url = "https://makedeals.ie/resetpassword/$email/$hash";

        if(ENVIRONMENT == "DEV") {
            $to = "cardeol@gmail.com";
            $url = "http://dev.makedeals.ie/app/resetpassword/$email/$hash";
        };
        ...
        To reset your Makedeals.ie account password please click on this link.
